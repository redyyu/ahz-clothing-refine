...
group:getOrCreateLocation("Shoes")-- Render shoes over everything else
...
group:getOrCreateLocation("RH93KneeArmor")
group:getOrCreateLocation("RH93ElbowArmor")
group:getOrCreateLocation("RH93FullArmor")
